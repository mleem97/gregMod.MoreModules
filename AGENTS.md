# AGENTS.md — Hinweise für KI-Agenten (gregMod.MoreModules)

Repo: [https://github.com/mleem97/gregMod.MoreModules](https://github.com/mleem97/gregMod.MoreModules) · Lizenz: Apache-2.0 · Version: siehe `VERSION`.
